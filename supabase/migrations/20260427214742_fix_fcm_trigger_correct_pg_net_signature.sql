/*
  # إصلاح توقيع net.http_post في trigger FCM

  ## المشكلة
  - الدالة net.http_post لها توقيع: (url, body, params, headers)
  - الكود القديم كان يستخدم named params خاطئة

  ## الحل
  - استخدام التوقيع الصحيح
*/
